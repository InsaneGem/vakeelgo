...
import {
  ...
  Gavel, HelpCircle, Phone, Video, UserCheck, IndianRupee
} from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-56 bg-popover z-[110] mt-2 shadow-lg">
                ...
                <DropdownMenuItem
                  onClick={() => navigate('/lawyer/legal-guides')}
                ...
                <DropdownMenuItem
                  onClick={() => navigate('/lawyer/legal-updates')}
                  className="gap-2 cursor-pointer"
                >
        ...
        {mobileMenuOpen && (
          <>
            ...
            {/* Mobile Menu */}
            <div className="fixed top-[56px] left-0 right-0 z-50 bg-background border-t border-border animate-fade-in">
              <div className="max-h-[calc(100vh-56px)] overflow-y-auto no-scrollbar">
                <div className="flex flex-col gap-1 px-2 pb-4">
                  ...
                  <button className="flex items-center gap-3 px-3 py-3 rounded-lg hover:bg-secondary transition-colors text-left"
                    onClick={() => { navigate('/lawyer/legal-guides'); setMobileMenuOpen(false); }}
                  >
                  ...
                  <button className="flex items-center gap-3 px-3 py-3 rounded-lg hover:bg-secondary transition-colors text-left"
                    onClick={() => { navigate('/lawyer/legal-updates'); setMobileMenuOpen(false); }}
                  >
