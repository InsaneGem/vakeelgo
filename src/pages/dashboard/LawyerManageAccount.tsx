...
const LawyerManageAccount = () => {
  ...
  const isProfessionalIncomplete = !professional.education.trim() ||
    !professional.bar_council_number.trim() ||
    professional.specializations.length === 0 ||
    professional.chat_price_per_minute < 1 || professional.chat_price_per_minute > 100 ||
    professional.audio_price_per_minute < 1 || professional.audio_price_per_minute > 100 ||
    professional.video_price_per_minute < 1 || professional.video_price_per_minute > 100;
  ...
  const handleSaveAll = async () => {
    ...
    if (
      ...
      toast({ title: 'Validation Error', description: 'Please ensure all your pricing rates are between ₹1 and ₹100', variant: 'destructive' });
      return;
    }
